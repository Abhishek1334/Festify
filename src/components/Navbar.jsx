		...
		<>
			...
			{isTablet && (
				...
				<ul className='ml-10  flex flex-row justify-center space-x-5 h-full items-center text-sm text-navy-600 font-semibold mr-4 w-[80%] '>
					<li className='flex-1 p-2 rounded-lg hover:bg-gray-200 flex justify-center'>Find Events
					</li>
					<div className="w-[2px] h-10 bg-gray-300 " />
					<li className='flex-1 flex justify-center p-2 rounded-lg hover:bg-gray-200'>Create Events</li>
					<div className="w-[2px] h-10 bg-gray-300 " />
					<li className='flex-1 p-2 rounded-lg hover:bg-gray-200 flex justify-center'>Log In</li>
					<div className="w-[2px] h-10 bg-gray-300 " />
					<li className='flex-1 p-2 rounded-lg hover:bg-gray-200 flex justify-center'>Sign Up</li>
				</ul>
			...
			{isMobile && (
				<div className='flex flex-col justify-between items-center border-b  border-gray-200 gap-2  py-4 whitespace-nowrap bg-pink-50 w-full' >
					<div className='flex '>
				<div className="flex items-center justify-center h-full  w-full  mr-8 sm:w=1/3">
					<img src={logo} alt="logo" className='flex size-10 justify-self-center'/></div>
