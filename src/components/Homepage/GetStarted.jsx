...
const GetStarted = () => {
	const authContext = useContext(AuthContext) || {}; // ✅ Prevents potential crashes
	const { user } = authContext;

	// If user is logged in, return nothing or show alternative content
	if (user) {
		return null; // ✅ Explicitly return null for better readability
	}
