      ...
      <div className="max-w-md w-full mx-auto space-y-8 bg-white rounded-2xl shadow-xl p-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            ...
            <Link to="/signup" className="font-medium text-purple-600 hover:text-[#ff8d64cc]">
              Sign up
            </Link>
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6 bg-gradient-to" onSubmit={handleLogin}>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-sm">
              <Link to="/forgot-password" className="font-medium text-purple-600 hover:text-[#ff8d64cc]">
